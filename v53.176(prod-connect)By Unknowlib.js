...
const Connect = {
	init() {
		Interceptor.attach(Libg.offset(0x489050), { // ServerConnection::connectTo
			onEnter(args) {
...
const Misc = {
    init() {
      ...
      WriteToMemory(Libg.offset(0x60CAD4), 'Byte', 0) // LogicVersion::isChinaVersion
  
      WriteToMemory(Libg.offset(0x60CAA4), 'Byte', 0) // LogicVersion::isProd
      WriteToMemory(Libg.offset(0x60CABC), 'Byte', 1) // LogicVersion::isDev
      WriteToMemory(Libg.offset(0x7600D4), 'Byte', 1) // LogicVersion::isDeveloperBuild
